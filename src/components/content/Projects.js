...
export default function Projects() {
    ...
    return (
        <motion.div className="flex flex-col bottom-0 right-12 w-fit absolute gap-2 overflow-y-scroll h-screen py-28 custom-scrollbar" variants={pageVariants} initial="hidden" animate="visible" exit="exit">
