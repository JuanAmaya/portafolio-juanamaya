...
export default function Projects({ projectMode }) {
    ...
    return (
        <motion.div className={`flex flex-col bottom-0 right-12 w-fit absolute gap-2 overflow-y-scroll h-screen justify-center pb-24 custom-scrollbar pt-38rem`} variants={pageVariants} initial="hidden" animate="visible" exit="exit">
